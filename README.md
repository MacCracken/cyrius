...
| Stdlib modules | **88** (distfiles folded byte-identical from sibling repos; bayan 1.0.0 carve at v6.1.25 moved 7 data modules → `lib/bayan.cyr`; see [docs/stdlib-modules.md](docs/stdlib-modules.md)) |
