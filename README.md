...
| Stdlib modules | **99** (distfiles folded byte-identical; bayan 1.4.0 → `lib/bayan.cyr`, ganita 1.0.4 → `lib/ganita.cyr`, `lib/sys.cyr` system-introspection @ v6.1.28; see [docs/stdlib-modules.md](docs/stdlib-modules.md)) |
