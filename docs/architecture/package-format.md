...
> pin field; `[deps]` / `[deps.stdlib]` shape; `cc5` toolchain
...
language = "cyrius"
cyrius = "5.11.63"          # toolchain pin (cc5 currently; cyc post-v6.0.0)
...
build = ["cyrius"]         # needs cc5 to build from source

[build]
configure = ""
make = "cat src/main.cyr | cc5 > build/kybernet && chmod +x build/kybernet"
check = "cat src/test.cyr | cc5 > /tmp/test && chmod +x /tmp/test && /tmp/test"
