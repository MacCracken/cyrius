...
**Status:** 🟡 **OPEN** — 7-line self-proving repro; reproduced at 6.6.0, 6.6.1 and 6.6.2.
**Placement:** unpinned. Blocks the 6.6.2 migration of a **10-repo cluster** (see Consumer impact)
