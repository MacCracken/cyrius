...
**Status:** 🔴 **OPEN.** Filed by hisab (3.2.0 work, 2026-09-14). The repro under `repros/` is
self-proving: exit 1 on the stock compiler, exit 0 with `CYRIUS_REGALLOC_PICKER_CAP=0`. hisab's
copy: `hisab/docs/development/issues/2026-09-14-cyrius-simd-dst-slot-regalloc-picker.md`.
