...
| v5.11.28 | **bote parser quirk: `assert(streq(call(args,n), "lit") == 1, "msg")` shape** (Low; bote 2.7.1 filed 2026-05-10; bumped from v5.11.27 at 2026-05-12 pi-verify mid-slot. Misleading `expected ')', got string` diagnostic; path-dependent trigger; consumer var-staging workaround in place. Slot: bisect minimal repro, fix tokenizer position-tracking, OR improve diagnostic — either layer acceptable.) |
