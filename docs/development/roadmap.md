...
2. **Undefined-fn reachable-call hard-error** — its **own slot** (user 2026-06-28,
   un-bundled from lever 2 once A landed and the blast radius was measured). [v6.3.2]
