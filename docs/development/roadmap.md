...
| **v6.1.41+** ⏳ | **dep-fold cycle-close → v6.2.0** — Phase F complete (F1+F2+F3 + .39 diagnostic audit). Bug bandwidth as filed; follow-up: a permanent check.sh gate for syscall-write byte-lengths (from the .39 audit). | → v6.2.0 |
