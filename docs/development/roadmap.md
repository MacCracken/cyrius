...
3. **Bare-metal deliverable completion (#5/#6/#7)** — the structured pass over the three open
   ...
   filed `issues/2026-06-28-bare-metal-forbidden-module-check-unbuilt.md`, P3.) **NEXT: Phase-0 substrate [v6.3.5]**
   (AR-01 monomorphization token-replay revival + CO-01 order-independent call ABI).
