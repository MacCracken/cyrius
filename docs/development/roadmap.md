...
| **v6.1.39+** ⏳ | **Phase F tail** — F1+F2 done, F3 5/6 shipped; remaining: CVE-24 locals-table redesign (slot-indexed overflow). Then the dep-fold cycle-close → v6.2.0; bug bandwidth as filed. | F → v6.2.0 |
