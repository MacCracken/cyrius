...
| **cycc_aarch64** (x86-host cross, emits aarch64) | **625,680 B** (rebuilt @ 6.2.43 version-bump — grew from the .41 shared frontend/backend changes (EF64_CMP NaN fix + `_CHECK_ARITY`); pi SELFHOST_OK) |
