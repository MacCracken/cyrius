...
| | |
|---|---|
| **Version** | **6.5.4** — the stdlib's first ordering primitive (`vec_sort_by` / `vec_select_nth`), four sibling folds, and a release gate that could not see the defect it gated. |
| **cycc** | x86 **1,133,440 B** · seed 29,024 B → cybs → cycc byte-identical |
| **Bootstrap / cross-OS** | **ecb** (macOS-arm64) · **ach** (Intel-Mac x86-macho) · **cass** (Windows PE) · **pi** (aarch64) — all `SELFHOST_OK` + VR-01 `LIBTEST_OK` on REAL hardware at 6.5.4 |
