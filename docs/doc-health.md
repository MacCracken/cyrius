...
|---|---|---|---|
| `README.md` | 2026-06-06 | ✅ Fresh | **Refreshed 2026-06-06 (v6.0.73)**: current-state metrics → cycc 929,072 B at v6.0.73, 85 check.sh gates, 162 .tcyr, 90 modules; cross-compiler (`cycc_aarch64` 590,536 B / `cycc_win` 801,280 B) + bootstrap-chain figures updated. Historical "as of v5.11.x" feature-landing markers retained. |
...
| `docs/guides/faq.md` | 2026-05-27 | 🟡 Stale | **Version/size marker last refreshed 2026-05-27 (v6.0.3)**: ~874 KB at v6.0.3 — now stale (cycc is 929,072 B / ~907 KB at v6.0.73, well past the ±50 KB currency gate). self_compile ~387 ms figure retained (v5.10.40/.41 miniarc). Size marker due for refresh. |
...
| `docs/size-comparisons.md` | 2026-06-06 | ✅ Fresh | **cycc-size refreshed 2026-06-06 (v6.0.73)**: → **929,072 B** (cycc) / 590,536 B (cycc_aarch64) / 801,280 B (cycc_win). cycc vs gcc/clang/rustc binary size table (comparison-tool figures still from the 2026-05-03 sweep). |
| `docs/platform-status.md` | 2026-06-06 | ✅ Fresh | **cycc-size marker refreshed 2026-06-06 (v6.0.73)**: ~929 KB. Per-target status table. Windows COM/Win64 callptr path validated on real cass at .71 (ECALLPTR_PE frame fix). |
