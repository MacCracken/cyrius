...
| `roadmap.md` | 2026-05-20 | ✅ Fresh | **Rewritten at v6.0.0 cycle-open** — 6-minor v6.x cycle structure (v6.0.x cleanup + stdlib clean-slate / v6.1.x PIE + .gnu.hash / v6.2.x bare-metal + RISC-V / v6.3.x language refinements / v6.4.x ABI + perf / v6.5.x self-compile perf-refactor). H2 per cycle. ~30-slot budget per minor (20 plan + 10 bandwidth) per user direction. |
