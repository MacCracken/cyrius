...
| `lib/yantra.cyr` | **v6.2.26** (refold v6.6.0) | yantra 1.0.4 | UI/E2E testing (WebDriver + Appium + Chromium-CDP RPC). Requires its dep chain in order: net / ws / bayan / sandhi / tls / sakshi / sigil. |
