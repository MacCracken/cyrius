...
|----------|--------|--------|
| Linux x86_64 | ELF | **✅ Narrow + Broad** — primary host. cycc ~1.06 MB (1,063,800 B at v6.2.5 — Phase 0 growable pressure tables: fixup_tbl / fn-tables / codebuf; x86-only); 3-step bootstrap byte-identical. |
