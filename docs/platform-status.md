...
|----------|--------|--------|
| Linux x86_64 | ELF | **✅ Narrow + Broad** — primary host. cycc ~1.06 MB (1,057,568 B at v6.4.10; x86 packed-SIMD/AVX2 emitters in float.cyr; x86-only); 3-step bootstrap byte-identical. |
