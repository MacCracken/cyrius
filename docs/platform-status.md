...
|----------|--------|--------|
| Linux x86_64 | ELF | **✅ Narrow + Broad** — primary host. cycc ~1.05 MB (1,055,784 B at v6.2.0 — Phase 0 growable pressure tables: fixup_tbl / fn-tables / codebuf; x86-only); 3-step bootstrap byte-identical. |
