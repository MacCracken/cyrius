...
|----------|--------|--------|
| Linux x86_64 | ELF | **✅ Narrow + Broad** — primary host. cycc ~1.05 MB (1,050,608 B at v6.1.41 — 16 MB binary-output cap raise + bayan/ganita stdlib carves; x86-only); 3-step bootstrap byte-identical. |
