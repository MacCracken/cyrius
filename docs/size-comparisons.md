...
>
> **Last measured**: 2026-06-06, at Cyrius v6.0.73 (Cyrius self-host figures; the
...
For perspective, the Cyrius compiler itself (cycc) is **929,072 B**
(~929 KB) on Linux ELF at v6.0.73. It compiles itself byte-identically.
...
- Cyrius cycc (Linux ELF): **929,072 B** (v6.0.73)
- cycc_aarch64 (Linux aarch64 cross): **590,536 B** (v6.0.73; the
...
- cycc_win (Windows PE cross): **801,280 B** (v6.0.73; PE format
