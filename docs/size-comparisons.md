...
>
> **Last measured**: 2026-06-12, at Cyrius v6.2.0 (Cyrius self-host figures; the
...
|----------|-----------|-----------|------:|---------:|
| **Cyrius** | cycc 6.2.0 | `echo 'syscall(60, 42);' \| cycc` | **504** | 1× |
...
| **Cyrius** | cycc 6.2.0 Linux cross-build | `CYRIUS_TARGET_WIN=1 cycc` | 1,536 | 1× (byte-identical to native) |
...
For perspective, the Cyrius compiler itself (cycc) is **1,055,784 B**
(~1,051 KB / ~1.05 MB) on Linux ELF at v6.2.0. It compiles itself byte-identically.
...
- Cyrius cycc (Linux ELF): **1,055,784 B** (v6.2.0)
- cycc_aarch64 (Linux aarch64 cross): **605,416 B** (v6.2.0; the
