...
>
> **Last measured**: 2026-06-11, at Cyrius v6.1.41 (Cyrius self-host figures; the
...
|----------|-----------|-----------|------:|---------:|
| **Cyrius** | cycc 6.1.41 | `echo 'syscall(60, 42);' \| cycc` | **504** | 1× |
...
| Language | Toolchain | Invocation | Bytes | × Cyrius |
|----------|-----------|-----------|------:|---------:|
| **Cyrius** | cycc_win 6.1.41 native (on Windows) | `cycc_win.exe < exit42.cyr` | **1,536** | 1× |
| **Cyrius** | cycc 6.1.41 Linux cross-build | `CYRIUS_TARGET_WIN=1 cycc` | 1,536 | 1× (byte-identical to native) |
...
For perspective, the Cyrius compiler itself (cycc) is **1,050,608 B**
(~1,051 KB / ~1.05 MB) on Linux ELF at v6.1.41. It compiles itself byte-identically.
...
- Cyrius cycc (Linux ELF): **1,050,608 B** (v6.1.41)
- cycc_aarch64 (Linux aarch64 cross): **595,800 B** (v6.1.41; the
...
- cycc_win (Windows PE cross): **814,592 B** (v6.1.41; PE format
