...
>
> **Last measured**: 2026-06-07, at Cyrius v6.0.87 (Cyrius self-host figures; the
...
For perspective, the Cyrius compiler itself (cycc) is **931,072 B**
(~931 KB) on Linux ELF at v6.0.87. It compiles itself byte-identically.
...
- Cyrius cycc (Linux ELF): **931,072 B** (v6.0.87)
- cycc_aarch64 (Linux aarch64 cross): **591,152 B** (v6.0.87; the
...
- cycc_win (Windows PE cross): **803,840 B** (v6.0.87; PE format
