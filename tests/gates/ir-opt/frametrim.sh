#!/bin/sh
# tests/gates/ir-opt/frametrim.sh — v6.3.29 callee-saved frame-trim gate.
#
...
for t in tests/tcyr/memory/alloc_collections.tcyr tests/tcyr/math/bigint.tcyr tests/tcyr/lang/closures.tcyr \
         tests/tcyr/lang/core.tcyr tests/tcyr/derive/derive_serialize_roundtrip.tcyr tests/tcyr/stdlib/chrono.tcyr; do
    [ -f "$t" ] || continue
